...
{
    public class PatientSignupDTO : IValidatableObject
    {
        ...
        [Required(ErrorMessage = "The {0} field is required.")]
        [StringLength(15, MinimumLength = 11, ErrorMessage = "Amka must be between 11 and 15 characters.")]
        [RegularExpression(@"^\S+$", ErrorMessage = "The {0} cannot contain whitespaces.")]
        ...
        {
            if (UserRole.HasValue && UserRole != Core.Enums.UserRole.Patient)
            {
